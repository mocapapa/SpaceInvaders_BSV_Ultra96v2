...
# ----------------------------------------------------------------------------
# Bank 65
set_property PACKAGE_PIN D7 [get_ports RD]
set_property PACKAGE_PIN F8 [get_ports GD]
set_property PACKAGE_PIN F7 [get_ports BD]
set_property PACKAGE_PIN G7 [get_ports HS]
set_property PACKAGE_PIN F6 [get_ports VS]
set_property PACKAGE_PIN G5 [get_ports MCLK]
set_property PACKAGE_PIN A6 [get_ports LRCLK]
set_property PACKAGE_PIN A7 [get_ports SDOUT]
set_property PACKAGE_PIN G6 [get_ports SCK]
set_property PACKAGE_PIN E6 [get_ports XSTART_SW]
set_property PACKAGE_PIN E5 [get_ports XFIRE_SW]
set_property PACKAGE_PIN D6 [get_ports XRIGHT_SW]
set_property PACKAGE_PIN D5 [get_ports XLEFT_SW]
set_property PACKAGE_PIN C7 [get_ports {COUNT[0]}]
set_property PACKAGE_PIN B6 [get_ports {COUNT[1]}]
set_property PACKAGE_PIN C5 [get_ports {COUNT[2]}]
#set_property PACKAGE_PIN U4 [get_ports UART_TX]
...
set_property IOSTANDARD LVCMOS18 [get_ports GD]
set_property IOSTANDARD LVCMOS18 [get_ports BD]
...
set_property IOSTANDARD LVCMOS18 [get_ports XSTART_SW]
set_property IOSTANDARD LVCMOS18 [get_ports XFIRE_SW]
set_property IOSTANDARD LVCMOS18 [get_ports XRIGHT_SW]
set_property IOSTANDARD LVCMOS18 [get_ports XLEFT_SW]
...
#set_multicycle_path -from [get_pins top_i/graphics/graphic_control_0/inst/VS_reg_inv/C] -to [get_pins {top_i/graphics/read_mem_0/inst/vcounter_reg[4]/R}] 1
#set_multicycle_path -from [get_clocks -of_objects [get_pins top_i/clk_wiz_0/inst/mmcme4_adv_inst/CLKOUT2]] -to [get_clocks -of_objects [get_pins top_i/clk_wiz_0/inst/mmcme4_adv_inst/CLKOUT1]] 1
#set_multicycle_path -from [get_clocks -of_objects [get_pins top_i/clk_wiz_0/inst/mmcme4_adv_inst/CLKOUT2]] -to [get_clocks -of_objects [get_pins top_i/clk_wiz_0/inst/mmcme4_adv_inst/CLKOUT1]] 1

set_multicycle_path -from [get_pins {design_1_i/sound/para_seri_0/inst/count_reg[5]/C}] -to [get_pins design_1_i/sound/handshake/OneStage_0/inst/empty_reg/D] 1
