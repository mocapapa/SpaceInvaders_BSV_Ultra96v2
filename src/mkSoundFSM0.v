...
//
// On Wed Jun  3 09:26:55 JST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkSoundFSM0(CLK,
  ...
  reg [14 : 0] MUX_romaddr$write_1__VAL_3;
  ...
  reg [2 : 0] CASE_state_BITS_4_TO_2_0_1_1_2_2_3_4__q4,
	      CASE_x393_0_rs_0_BITS_4_TO_2_1_rs_1_BITS_4_TO__ETC__q2;
  reg [1 : 0] CASE_state_BITS_1_TO_0_0_1_1_2_3__q1,
	      CASE_x393_0_rs_0_BITS_1_TO_0_1_rs_1_BITS_1_TO__ETC__q3;
  wire [4 : 0] SEL_ARR_rs_0_09_BITS_4_TO_2_10_rs_1_11_BITS_4__ETC___d123,
	       state_BITS_4_TO_2_CONCAT_IF_state_BITS_1_TO_0__ETC___d21;
  wire [1 : 0] x__h3393;
  wire NOT_code_wget__2_EQ_1_3_7_AND_NOT_code_wget__2_ETC___d93,
       code_wget__2_EQ_1_3_OR_code_wget__2_EQ_2_4_5_O_ETC___d82;
  ...
  assign MUX_dcount$write_1__SEL_1 =
	     WILL_FIRE_RL_rule_PLAY_rule_S3 &&
	     NOT_code_wget__2_EQ_1_3_7_AND_NOT_code_wget__2_ETC___d93 &&
	     dcount != 15'd0 ;
  ...
  assign MUX_ren$write_1__SEL_1 =
	     WILL_FIRE_RL_rule_GETPACKET_rule_S0 &&
	     (sound_code == 4'd1 || sound_code == 4'd2 ||
	      sound_code == 4'd9) ;
  assign MUX_romaddr$write_1__SEL_3 =
	     WILL_FIRE_RL_rule_FORMAT_rule_S0 &&
	     (current == 4'd1 || current == 4'd2 || current == 4'd9) ;
  ...
  assign MUX_rs_0$write_1__SEL_3 =
	     WILL_FIRE_RL_rule_PLAY_rule_S3 && sp == 2'd0 &&
	     NOT_code_wget__2_EQ_1_3_7_AND_NOT_code_wget__2_ETC___d93 &&
	     dcount != 15'd0 ;
  ...
  assign MUX_rs_1$write_1__SEL_3 =
	     WILL_FIRE_RL_rule_PLAY_rule_S3 && sp == 2'd1 &&
	     NOT_code_wget__2_EQ_1_3_7_AND_NOT_code_wget__2_ETC___d93 &&
	     dcount != 15'd0 ;
  ...
  assign MUX_rs_2$write_1__SEL_3 =
	     WILL_FIRE_RL_rule_PLAY_rule_S3 && sp == 2'd2 &&
	     NOT_code_wget__2_EQ_1_3_7_AND_NOT_code_wget__2_ETC___d93 &&
	     dcount != 15'd0 ;
  ...
  begin
    case (current)
      4'd1: MUX_romaddr$write_1__VAL_3 = 15'd16;
      4'd2: MUX_romaddr$write_1__VAL_3 = 15'd4334;
      default: MUX_romaddr$write_1__VAL_3 = 15'd13110;
    endcase
  end
  ...
  assign MUX_state$write_1__VAL_8 =
	     (i == 8'd0) ?
	       SEL_ARR_rs_0_09_BITS_4_TO_2_10_rs_1_11_BITS_4__ETC___d123 :
	       { state[4:2], 2'd1 } ;
  ...
  // register fNO9
  assign fNO9$D_IN = sound_code == 4'd9 ;
  assign fNO9$EN = MUX_ren$write_1__SEL_1 ;
  ...
  always@(MUX_dcount$write_1__SEL_1 or
	  ...
	  MUX_dcount$write_1__SEL_2 or
	  x__h3393 or MUX_sp$write_1__SEL_3 or MUX_sp$write_1__SEL_4)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_dcount$write_1__SEL_1: sp$D_IN = MUX_sp$write_1__VAL_1;
      MUX_dcount$write_1__SEL_2: sp$D_IN = x__h3393;
      MUX_sp$write_1__SEL_3: sp$D_IN = x__h3393;
  ...
  always@(MUX_state$write_1__SEL_1 or
	  ...
	  SEL_ARR_rs_0_09_BITS_4_TO_2_10_rs_1_11_BITS_4__ETC___d123 or
	  WILL_FIRE_RL_rule_PLAY_rule_S3 or
  ...
  // remaining internal signals
  assign NOT_code_wget__2_EQ_1_3_7_AND_NOT_code_wget__2_ETC___d93 =
	     sound_code != 4'd1 && sound_code != 4'd2 && sound_code != 4'd9 ||
	     fNO9 ||
	     emptyf ;
  assign SEL_ARR_rs_0_09_BITS_4_TO_2_10_rs_1_11_BITS_4__ETC___d123 =
	     { CASE_x393_0_rs_0_BITS_4_TO_2_1_rs_1_BITS_4_TO__ETC__q2,
	       CASE_x393_0_rs_0_BITS_1_TO_0_1_rs_1_BITS_1_TO__ETC__q3 } ;
  assign code_wget__2_EQ_1_3_OR_code_wget__2_EQ_2_4_5_O_ETC___d82 =
	     (sound_code == 4'd1 || sound_code == 4'd2 ||
	      sound_code == 4'd9) &&
	     !fNO9 &&
	     !emptyf ;
  ...
  always@(x__h3393 or rs_0 or rs_1 or rs_2)
  begin
    case (x__h3393)
      2'd0:
	  CASE_x393_0_rs_0_BITS_4_TO_2_1_rs_1_BITS_4_TO__ETC__q2 = rs_0[4:2];
      2'd1:
	  CASE_x393_0_rs_0_BITS_4_TO_2_1_rs_1_BITS_4_TO__ETC__q2 = rs_1[4:2];
      2'd2:
	  CASE_x393_0_rs_0_BITS_4_TO_2_1_rs_1_BITS_4_TO__ETC__q2 = rs_2[4:2];
      2'd3:
	  CASE_x393_0_rs_0_BITS_4_TO_2_1_rs_1_BITS_4_TO__ETC__q2 =
  ...
  begin
    case (x__h3393)
      2'd0:
	  CASE_x393_0_rs_0_BITS_1_TO_0_1_rs_1_BITS_1_TO__ETC__q3 = rs_0[1:0];
      2'd1:
	  CASE_x393_0_rs_0_BITS_1_TO_0_1_rs_1_BITS_1_TO__ETC__q3 = rs_1[1:0];
      2'd2:
	  CASE_x393_0_rs_0_BITS_1_TO_0_1_rs_1_BITS_1_TO__ETC__q3 = rs_2[1:0];
      2'd3:
	  CASE_x393_0_rs_0_BITS_1_TO_0_1_rs_1_BITS_1_TO__ETC__q3 =
