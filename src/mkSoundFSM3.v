...
//
// On Sat Apr 18 19:00:45 JST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkSoundFSM3(CLK,
  ...
  wire MUX_dcount$write_1__SEL_1,
       ...
       MUX_state$write_1__SEL_11,
       MUX_state$write_1__SEL_3,
       MUX_state$write_1__SEL_4;

  // remaining internal signals
  reg [2 : 0] CASE_state_BITS_4_TO_2_0_1_1_2_2_3_4__q4,
	      CASE_x544_0_rs_0_BITS_4_TO_2_1_rs_1_BITS_4_TO__ETC__q2;
  reg [1 : 0] CASE_state_BITS_1_TO_0_0_1_1_2_3__q1,
	      CASE_x544_0_rs_0_BITS_1_TO_0_1_rs_1_BITS_1_TO__ETC__q3;
  wire [4 : 0] IF_dcount_1_EQ_0_0_THEN_IF_fUFO_9_AND_emptyf_3_ETC___d85,
	       SEL_ARR_rs_0_06_BITS_4_TO_2_07_rs_1_08_BITS_4__ETC___d120,
	       state_BITS_4_TO_2_CONCAT_IF_state_BITS_1_TO_0__ETC___d21;
  wire [1 : 0] x__h3544;
  wire sp_4_EQ_0_5_AND_NOT_code_wget__2_EQ_8_3_7_AND__ETC___d95,
       sp_4_EQ_1_6_AND_NOT_code_wget__2_EQ_8_3_7_AND__ETC___d96,
       sp_4_EQ_2_7_AND_NOT_code_wget__2_EQ_8_3_7_AND__ETC___d97;
  ...
  assign MUX_dcount$write_1__SEL_1 =
	     WILL_FIRE_RL_rule_PLAY_rule_S3 &&
	     (sound_code != 4'd8 && sound_code != 4'd11 || emptyf) &&
	     dcount != 15'd0 ;
  ...
  assign MUX_ren$write_1__SEL_1 =
	     WILL_FIRE_RL_rule_GETPACKET_rule_S0 &&
	     (sound_code == 4'd8 || sound_code == 4'd10 ||
	      sound_code == 4'd11) ;
  assign MUX_romaddr$write_1__SEL_3 =
	     WILL_FIRE_RL_rule_FORMAT_rule_S0 && (fUFO || current == 4'd8) ;
  ...
  assign MUX_rs_0$write_1__SEL_3 =
	     WILL_FIRE_RL_rule_PLAY_rule_S3 &&
	     sp_4_EQ_0_5_AND_NOT_code_wget__2_EQ_8_3_7_AND__ETC___d95 ;
  ...
  assign MUX_state$write_1__SEL_10 =
	     WILL_FIRE_RL_rule_DATALEN_rule_S0 ||
	     WILL_FIRE_RL_rule_FORMAT_rule_S0 ;
  assign MUX_state$write_1__SEL_11 =
	     WILL_FIRE_RL_rule_READCOUNT_rule_S1 ||
	     WILL_FIRE_RL_rule_PLAY_rule_S2 ||
	     WILL_FIRE_RL_rule_PLAY_rule_S1 ||
	     WILL_FIRE_RL_rule_PLAY_rule_S0 ;
  ...
  assign MUX_romaddr$write_1__VAL_3 = fUFO ? 15'd25984 : 15'd16 ;
  ...
  assign MUX_state$write_1__VAL_8 =
	     ((sound_code == 4'd8 || sound_code == 4'd11) && !emptyf) ?
	       5'd0 :
	       IF_dcount_1_EQ_0_0_THEN_IF_fUFO_9_AND_emptyf_3_ETC___d85 ;
  assign MUX_state$write_1__VAL_9 =
	     (i == 8'd0) ?
	       SEL_ARR_rs_0_06_BITS_4_TO_2_07_rs_1_08_BITS_4__ETC___d120 :
	       { state[4:2], 2'd1 } ;
  ...
  // register fUFO
  assign fUFO$D_IN = sound_code == 4'd10 ;
  assign fUFO$EN = MUX_ren$write_1__SEL_1 ;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      ...
      MUX_romaddr$write_1__SEL_3: romaddr$D_IN = MUX_romaddr$write_1__VAL_3;
      WILL_FIRE_RL_rule_DATALEN_rule_S0:
  ...
  always@(MUX_rs_0$write_1__SEL_4 or
	  state_BITS_4_TO_2_CONCAT_IF_state_BITS_1_TO_0__ETC___d21 or
  ...
  always@(MUX_dcount$write_1__SEL_1 or
	  ...
	  MUX_dcount$write_1__SEL_2 or
	  x__h3544 or MUX_sp$write_1__SEL_3 or MUX_sp$write_1__SEL_4)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_dcount$write_1__SEL_1: sp$D_IN = MUX_sp$write_1__VAL_1;
      MUX_dcount$write_1__SEL_2: sp$D_IN = x__h3544;
      MUX_sp$write_1__SEL_3: sp$D_IN = x__h3544;
  ...
  always@(MUX_state$write_1__SEL_1 or
	  ...
	  SEL_ARR_rs_0_06_BITS_4_TO_2_07_rs_1_08_BITS_4__ETC___d120 or
	  WILL_FIRE_RL_rule_GETPACKET_rule_S1 or
	  MUX_state$write_1__VAL_7 or
	  WILL_FIRE_RL_rule_PLAY_rule_S3 or
	  MUX_state$write_1__VAL_8 or
	  WILL_FIRE_RL_rule_READCOUNT_rule_S2 or
	  MUX_state$write_1__VAL_9 or
	  MUX_state$write_1__SEL_10 or
	  MUX_state$write_1__SEL_11 or WILL_FIRE_RL_rule_DATALEN_rule_S1)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_state$write_1__SEL_1:
	  state$D_IN =
	  ...
	  state$D_IN =
	      state_BITS_4_TO_2_CONCAT_IF_state_BITS_1_TO_0__ETC___d21;
      WILL_FIRE_RL_rule_FORMAT_rule_S1: state$D_IN = MUX_state$write_1__VAL_3;
      MUX_sp$write_1__SEL_3:
	  state$D_IN =
	      SEL_ARR_rs_0_06_BITS_4_TO_2_07_rs_1_08_BITS_4__ETC___d120;
      WILL_FIRE_RL_rule_GETPACKET_rule_S1:
	  state$D_IN = MUX_state$write_1__VAL_7;
      WILL_FIRE_RL_rule_PLAY_rule_S3: state$D_IN = MUX_state$write_1__VAL_8;
      WILL_FIRE_RL_rule_READCOUNT_rule_S2:
	  state$D_IN = MUX_state$write_1__VAL_9;
      MUX_state$write_1__SEL_10: state$D_IN = 5'd20;
      MUX_state$write_1__SEL_11: state$D_IN = 5'd24;
  ...
  // remaining internal signals
  assign IF_dcount_1_EQ_0_0_THEN_IF_fUFO_9_AND_emptyf_3_ETC___d85 =
	     (dcount == 15'd0) ? ((fUFO && emptyf) ? 5'd4 : 5'd0) : 5'd24 ;
  assign SEL_ARR_rs_0_06_BITS_4_TO_2_07_rs_1_08_BITS_4__ETC___d120 =
	     { CASE_x544_0_rs_0_BITS_4_TO_2_1_rs_1_BITS_4_TO__ETC__q2,
	       CASE_x544_0_rs_0_BITS_1_TO_0_1_rs_1_BITS_1_TO__ETC__q3 } ;
  assign sp_4_EQ_0_5_AND_NOT_code_wget__2_EQ_8_3_7_AND__ETC___d95 =
	     sp == 2'd0 &&
	     (sound_code != 4'd8 && sound_code != 4'd11 || emptyf) &&
	     dcount != 15'd0 ;
  assign sp_4_EQ_1_6_AND_NOT_code_wget__2_EQ_8_3_7_AND__ETC___d96 =
	     sp == 2'd1 &&
	     (sound_code != 4'd8 && sound_code != 4'd11 || emptyf) &&
	     dcount != 15'd0 ;
  assign sp_4_EQ_2_7_AND_NOT_code_wget__2_EQ_8_3_7_AND__ETC___d97 =
	     sp == 2'd2 &&
	     (sound_code != 4'd8 && sound_code != 4'd11 || emptyf) &&
	     dcount != 15'd0 ;
  assign state_BITS_4_TO_2_CONCAT_IF_state_BITS_1_TO_0__ETC___d21 =
	     { state[4:2], CASE_state_BITS_1_TO_0_0_1_1_2_3__q1 } ;
  assign x__h3544 = sp - 2'd1 ;
  always@(state)
  begin
    case (state[1:0])
  ...
  always@(x__h3544 or rs_0 or rs_1 or rs_2)
  begin
    case (x__h3544)
      2'd0:
	  CASE_x544_0_rs_0_BITS_4_TO_2_1_rs_1_BITS_4_TO__ETC__q2 = rs_0[4:2];
      2'd1:
	  CASE_x544_0_rs_0_BITS_4_TO_2_1_rs_1_BITS_4_TO__ETC__q2 = rs_1[4:2];
      2'd2:
	  CASE_x544_0_rs_0_BITS_4_TO_2_1_rs_1_BITS_4_TO__ETC__q2 = rs_2[4:2];
      2'd3:
	  CASE_x544_0_rs_0_BITS_4_TO_2_1_rs_1_BITS_4_TO__ETC__q2 =
  ...
  begin
    case (x__h3544)
      2'd0:
	  CASE_x544_0_rs_0_BITS_1_TO_0_1_rs_1_BITS_1_TO__ETC__q3 = rs_0[1:0];
      2'd1:
	  CASE_x544_0_rs_0_BITS_1_TO_0_1_rs_1_BITS_1_TO__ETC__q3 = rs_1[1:0];
      2'd2:
	  CASE_x544_0_rs_0_BITS_1_TO_0_1_rs_1_BITS_1_TO__ETC__q3 = rs_2[1:0];
      2'd3:
	  CASE_x544_0_rs_0_BITS_1_TO_0_1_rs_1_BITS_1_TO__ETC__q3 =
