...
//
// On Sat Apr 18 19:00:44 JST 2020
//
//
// Ports:
// Name                         I/O  size props
...
module mkSoundFSM2(CLK,
  ...
  reg [2 : 0] CASE_state_BITS_4_TO_2_0_1_1_2_2_3_4__q4,
	      CASE_x451_0_rs_0_BITS_4_TO_2_1_rs_1_BITS_4_TO__ETC__q2;
  reg [1 : 0] CASE_state_BITS_1_TO_0_0_1_1_2_3__q1,
	      CASE_x451_0_rs_0_BITS_1_TO_0_1_rs_1_BITS_1_TO__ETC__q3;
  wire [4 : 0] SEL_ARR_rs_0_12_BITS_4_TO_2_13_rs_1_14_BITS_4__ETC___d126,
	       state_BITS_4_TO_2_CONCAT_IF_state_BITS_1_TO_0__ETC___d23;
  wire [1 : 0] x__h3451;
  wire NOT_code_wget__2_EQ_4_3_9_AND_NOT_code_wget__2_ETC___d98,
       code_wget__2_EQ_4_3_OR_code_wget__2_EQ_5_4_5_O_ETC___d86;
  ...
  assign MUX_dcount$write_1__SEL_1 =
	     WILL_FIRE_RL_rule_PLAY_rule_S3 &&
	     NOT_code_wget__2_EQ_4_3_9_AND_NOT_code_wget__2_ETC___d98 ;
  ...
  assign MUX_ren$write_1__SEL_1 =
	     WILL_FIRE_RL_rule_GETPACKET_rule_S0 &&
	     (sound_code == 4'd4 || sound_code == 4'd5 ||
	      sound_code == 4'd6 ||
	      sound_code == 4'd7) ;
  assign MUX_romaddr$write_1__SEL_3 =
	     WILL_FIRE_RL_rule_FORMAT_rule_S0 &&
	     (current == 4'd4 || current == 4'd5 || current == 4'd6 ||
	      current == 4'd7) ;
  ...
  begin
    case (current)
      4'd4: MUX_romaddr$write_1__VAL_3 = 15'd16;
      4'd5: MUX_romaddr$write_1__VAL_3 = 15'd1282;
      4'd6: MUX_romaddr$write_1__VAL_3 = 15'd2852;
      default: MUX_romaddr$write_1__VAL_3 = 15'd4422;
    endcase
  end
  ...
  assign MUX_state$write_1__VAL_8 =
	     (i == 8'd0) ?
	       SEL_ARR_rs_0_12_BITS_4_TO_2_13_rs_1_14_BITS_4__ETC___d126 :
	       { state[4:2], 2'd1 } ;
  ...
  always@(MUX_rs_0$write_1__SEL_4 or
	  state_BITS_4_TO_2_CONCAT_IF_state_BITS_1_TO_0__ETC___d23 or
  ...
  always@(MUX_dcount$write_1__SEL_1 or
	  ...
	  MUX_dcount$write_1__SEL_2 or
	  x__h3451 or MUX_sp$write_1__SEL_3 or MUX_sp$write_1__SEL_4)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_dcount$write_1__SEL_1: sp$D_IN = MUX_sp$write_1__VAL_1;
      MUX_dcount$write_1__SEL_2: sp$D_IN = x__h3451;
      MUX_sp$write_1__SEL_3: sp$D_IN = x__h3451;
  ...
  always@(MUX_state$write_1__SEL_1 or
	  ...
	  SEL_ARR_rs_0_12_BITS_4_TO_2_13_rs_1_14_BITS_4__ETC___d126 or
	  WILL_FIRE_RL_rule_PLAY_rule_S3 or
  ...
  // remaining internal signals
  assign NOT_code_wget__2_EQ_4_3_9_AND_NOT_code_wget__2_ETC___d98 =
	     (sound_code != 4'd4 && sound_code != 4'd5 &&
	      sound_code != 4'd6 &&
	      sound_code != 4'd7 ||
	      emptyf) &&
	     dcount != 15'd0 ;
  assign SEL_ARR_rs_0_12_BITS_4_TO_2_13_rs_1_14_BITS_4__ETC___d126 =
	     { CASE_x451_0_rs_0_BITS_4_TO_2_1_rs_1_BITS_4_TO__ETC__q2,
	       CASE_x451_0_rs_0_BITS_1_TO_0_1_rs_1_BITS_1_TO__ETC__q3 } ;
  assign code_wget__2_EQ_4_3_OR_code_wget__2_EQ_5_4_5_O_ETC___d86 =
	     (sound_code == 4'd4 || sound_code == 4'd5 ||
	      sound_code == 4'd6 ||
	      sound_code == 4'd7) &&
	     !emptyf ||
	     dcount == 15'd0 ;
  assign state_BITS_4_TO_2_CONCAT_IF_state_BITS_1_TO_0__ETC___d23 =
	     { state[4:2], CASE_state_BITS_1_TO_0_0_1_1_2_3__q1 } ;
  assign x__h3451 = sp - 2'd1 ;
  always@(state)
  begin
    case (state[1:0])
  ...
  always@(x__h3451 or rs_0 or rs_1 or rs_2)
  begin
    case (x__h3451)
      2'd0:
	  CASE_x451_0_rs_0_BITS_4_TO_2_1_rs_1_BITS_4_TO__ETC__q2 = rs_0[4:2];
      2'd1:
	  CASE_x451_0_rs_0_BITS_4_TO_2_1_rs_1_BITS_4_TO__ETC__q2 = rs_1[4:2];
      2'd2:
	  CASE_x451_0_rs_0_BITS_4_TO_2_1_rs_1_BITS_4_TO__ETC__q2 = rs_2[4:2];
      2'd3:
	  CASE_x451_0_rs_0_BITS_4_TO_2_1_rs_1_BITS_4_TO__ETC__q2 =
  ...
  begin
    case (x__h3451)
      2'd0:
	  CASE_x451_0_rs_0_BITS_1_TO_0_1_rs_1_BITS_1_TO__ETC__q3 = rs_0[1:0];
      2'd1:
	  CASE_x451_0_rs_0_BITS_1_TO_0_1_rs_1_BITS_1_TO__ETC__q3 = rs_1[1:0];
      2'd2:
	  CASE_x451_0_rs_0_BITS_1_TO_0_1_rs_1_BITS_1_TO__ETC__q3 = rs_2[1:0];
      2'd3:
	  CASE_x451_0_rs_0_BITS_1_TO_0_1_rs_1_BITS_1_TO__ETC__q3 =
